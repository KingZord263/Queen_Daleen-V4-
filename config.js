...
global.owner = process.env.OWNER_NUMBER.split('263718036108,263776404156'); 
global.anitav4 = process.env.BOT_NAME || "Queen Daleen�𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
global.ownername = process.env.OWNER_NAME || "King Zord";
global.packname = process.env.PACK_NAME || "Queen Daleen�𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
...
global.mess = {
    ...
    premium: process.env.MESSAGE_PREMIUM || '_*Premium only" Want Premium? Chat Owner-+263718036108*_',
